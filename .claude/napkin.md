...
2. **[2026-09-21] Before Phase 2 live cutover: review/harden signature verification's missing root-CA path-building**
...
4. **[2026-09-21] Phase 4 option: local llama.cpp backend is faster than OpenRouter but blocked by a reasoning-mode truncation bug — a plain server restart does NOT fix it**
